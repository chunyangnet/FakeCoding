...
4. Install the wheel into a fresh virtual environment and run `fakecoding --help` plus a finite Responses API smoke test.
...
Do not publish from an unclean working tree or skip the no-execution and continuous-disconnect tests.
